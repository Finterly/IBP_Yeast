...
setwd("~/Documents/bioinformatics-phase2/integrated-project/data/IBP_Yeast")
...
write.table(num_SNPs_Reactor1_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor1_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 2
num_SNPs_Reactor2_per_Chr = table(SNP_Reactor2$Chr)
write.table(num_SNPs_Reactor2_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor2_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 3
num_SNPs_Reactor3_per_Chr = table(SNP_Reactor3$Chr)
write.table(num_SNPs_Reactor3_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor3_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 4
num_SNPs_Reactor4_per_Chr = table(SNP_Reactor4$Chr)
write.table(num_SNPs_Reactor4_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor4_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 5
num_SNPs_Reactor5_per_Chr = table(SNP_Reactor5$Chr)
write.table(num_SNPs_Reactor5_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor5_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 6
num_SNPs_Reactor6_per_Chr = table(SNP_Reactor6$Chr)
write.table(num_SNPs_Reactor6_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_snps_reactor6_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Counting number of indels per chromosome
# Reactor 3
num_indels_Reactor3_per_Chr = table(INDEL_Reactor3$Chr)
write.table(num_indels_Reactor3_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_indels_reactor3_per_chr.txt", quote=F, row.names = F, sep ="\t")

# Reactor 4
num_indels_Reactor4_per_Chr = table(INDEL_Reactor4$Chr)
write.table(num_indels_Reactor4_per_Chr, "/home/arana/Documents/bioinformatics-phase2/integrated-project/num_indels_reactor4_per_chr.txt", quote=F, row.names = F, sep ="\t")
...
write.table(SNP_reactor3_genelist, "/home/arana/Documents/bioinformatics-phase2/integrated-project/data/snps_reactor3_genelist", sep = "\t", quote = F, row.names = F, col.names = F)
